...
def attack(char_name: str, char_class: str) -> str:
    """
    Выполняет атаку персонажа и возвращает сообщение о нанесенном уроне.

    :param char_name: Имя персонажа.
    :param char_class: Класс персонажа (warrior, mage, healer).
    :return: Сообщение о нанесенном уроне.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Выполняет защиту персонажа и возвращает сообщение о заблокированном уроне.

    :param char_name: Имя персонажа.
    :param char_class: Класс персонажа (warrior, mage, healer).
    :return: Сообщение о заблокированном уроне.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Применяет специальное умение персонажа и возвращает сообщение о его использовании.
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Запускает тренировку персонажа с возможностью выполнения команд.
